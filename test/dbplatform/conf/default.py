...
APP_ID = 'dbplatform'
APP_TOKEN = '58465085-8bcf-45d3-bb26-3357763ad8e5'
# 蓝鲸智云开发者中心的域名，形如：http://paas.bking.com
BK_PAAS_HOST = 'http://paas.depponbke.com:80'
cmdb_host = ''
OWNER_ID = '0'
# 是否启用celery任务
IS_USE_CELERY = True
...
CELERY_IMPORTS = (
    ...
    'home_application.sql_online',
    'home_application.run_db_check_task',
)
...
PARAM_DATA_JSON_FILE = os.path.join(PROJECT_ROOT, 'fixtures/initial_param_data.json')
INCEP_DATA_JSON_FILE = os.path.join(PROJECT_ROOT, 'fixtures/initial_incep_data.json')
