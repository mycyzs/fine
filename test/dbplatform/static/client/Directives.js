    ...
    return {
        ...
        template: '<div class="mytablebody">\
            ...
            <div class="table_control">\
                <div style="float: left">条目总数：{{ mytable_option.mytable_count }}&nbsp;&nbsp;&nbsp;&nbsp;每页<select ng-model="mytable_option.mytable_num" ng-change="reload()"><option value="10">10</option><option value="20">20</option><option value="50">50</option><option value="100">100</option></select></div>\
