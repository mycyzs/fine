        ...
        var leftMenuUtil = {
            BuildMenuHtml: function (leftMenuOptions) {
                var menuBody = ' <div class="sidebar" id="sidebar_cwLeftMenu">\
                                   <div style="border-bottom:solid;border-bottom-width:1px;border-bottom-color:transparent">\
            ...
            ApplyMenu: function () {
                ...
                jQuery(function (a) {
                    window.ace.sidebar_collapsed = function (c) {
                        ...
                        $('[ng-grid]').each(function () {
                            var ng_option = $(this).attr('ng-grid');
                            var pp = $('#ui-view-content').scope();
                            pp[ng_option].$gridServices.DomUtilityService.RebuildGrid(
                                pp[ng_option].$gridScope,
                                pp[ng_option].ngGrid
                            );
                        })
                    };
